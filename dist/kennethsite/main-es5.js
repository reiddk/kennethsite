  ...
  function srcAppBookViewBookViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BookViewComponent = /*#__PURE__*/function () {
      ...
      _createClass(BookViewComponent, [{
          ...
          if (this.bookInfos && this.bookInfos.length && this.pdfName && this.pdfPage) {
            ...
            this.regIntervalSub = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(500).subscribe(function () {
              if (_this4.storageService.getPageForBook(book.bookTitle) !== _this4.pdfPage.toString()) {
                gtag('set', 'page_path', "/book/".concat(book.bookTitle.replace(/\s/g, '-'), "/").concat(_this4.pdfPage.toString()));
        ...
        key: "setPdfPage",
        value: function setPdfPage(pageNum) {
          var _this5 = this;
          ...
          if (pageNum > this.numberOfPages) {
            setTimeout(function () {
              _this5.setPdfPage(pageNum, count + 1);
            }, 250);
            return;
          }
        ...
        value: function ngOnInit() {
          ...
          this.bookInfoSub = this.storageService.getupdatedBooksInfo().subscribe(function (out) {
            ...
            _this6.getPdfInfoFromRoute();
          });
          this.routerSub = this.route.url.subscribe(function (out) {
            if (out.length === 3) {
              _this6.pdfName = out[1].path.replace(/\-/g, ' ');
              _this6.bookURLname = out[1].path;

              _this6.setPdfPage(Number(out[2].path));

              _this6.loadingBookSource = "/assets/".concat(out[1].path).concat(_this6.pdfPage - 1, ".pdf");
              gtag('set', 'page_path', "/book/".concat(_this6.pdfName, "/").concat(_this6.pdfPage));
              gtag('event', 'page_view');
        ...
        value: function get(serviceUrl) {
          ...
          if (!this.storageService.currentlyRequestingUrl[url]) {
            ...
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              _this9.storageService.currentlyRequestingUrl[url] = false;
              return res;
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
              _this9.storageService.currentlyRequestingUrl[url] = false;
        ...
        value: function handleError(error) {
          ...
          switch (error.status) {
            ...
            case 401:
              ...
              setTimeout(function () {
                _this10.storageService.error401Called = false;
              }, 3000);
