...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppBookViewBookViewComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "pdf-viewer {\n  display: block;\n  height: 100vh;\n}\n\n.lds-hourglass {\n  display: inline-block;\n  position: relative;\n  width: 80px;\n  height: 80px;\n}\n\n.lds-hourglass:after {\n  content: \" \";\n  display: block;\n  border-radius: 50%;\n  width: 0;\n  height: 0;\n  margin: 8px;\n  box-sizing: border-box;\n  border: 32px solid #000;\n  border-color: #000 transparent #000 transparent;\n  -webkit-animation: lds-hourglass 1.2s infinite;\n          animation: lds-hourglass 1.2s infinite;\n}\n\n@-webkit-keyframes lds-hourglass {\n  0% {\n    -webkit-transform: rotate(0);\n            transform: rotate(0);\n    -webkit-animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n            animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  50% {\n    -webkit-transform: rotate(900deg);\n            transform: rotate(900deg);\n    -webkit-animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n            animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  100% {\n    -webkit-transform: rotate(1800deg);\n            transform: rotate(1800deg);\n  }\n}\n\n@keyframes lds-hourglass {\n  0% {\n    -webkit-transform: rotate(0);\n            transform: rotate(0);\n    -webkit-animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n            animation-timing-function: cubic-bezier(0.55, 0.055, 0.675, 0.19);\n  }\n  50% {\n    -webkit-transform: rotate(900deg);\n            transform: rotate(900deg);\n    -webkit-animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n            animation-timing-function: cubic-bezier(0.215, 0.61, 0.355, 1);\n  }\n  100% {\n    -webkit-transform: rotate(1800deg);\n            transform: rotate(1800deg);\n  }\n}\n\n.warning {\n  color: red;\n  text-align: center;\n  position: absolute;\n  z-index: 10;\n  max-width: 500px;\n  width: 50%;\n  left: 25%;\n  font-size: 10px;\n  background: #f8f9fa;\n  border-radius: 10px;\n  padding-top: 10px;\n  margin-top: -9px;\n  -webkit-transition: max-height 2s cubic-bezier(0, 1, 0, 1);\n  transition: max-height 2s cubic-bezier(0, 1, 0, 1);\n  max-height: 0px;\n  overflow-y: hidden;\n}\n\n.warning-show {\n  max-height: 150px;\n}\n\n.loading-progress-container {\n  width: 60px;\n  height: 6px;\n  border: 1px black solid;\n  position: absolute;\n  top: 0px;\n}\n\n.loading-progress {\n  width: 0%;\n  background-color: black;\n  height: 5px;\n}\n\n.loading-percent {\n  font-weight: bold;\n  text-align: center;\n  width: 60px;\n  padding: 5px;\n}\n\n.navigationbar-wrapper {\n  background-color: #f8f9fa;\n  display: -webkit-box;\n  display: flex;\n}\n\n.cell-one {\n  -webkit-box-flex: 1;\n          flex: 1;\n  height: 60px;\n}\n\n@media (max-width: 768px) {\n  .cell-one {\n    height: 45px;\n  }\n}\n\n.cell-two {\n  -webkit-box-flex: 3;\n          flex: 3;\n}\n\n@media (max-width: 768px) {\n  .cell-two {\n    height: 45px;\n  }\n}\n\n.navigation-wrapper {\n  list-style: none;\n  display: -webkit-box;\n  display: flex;\n  margin: 0px;\n  -webkit-box-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\n\n@media (max-width: 768px) {\n  .navigation-wrapper {\n    height: 45px;\n  }\n}\n\n@media (max-width: 575px) {\n  .navigation-wrapper {\n    padding-left: 0px;\n  }\n}\n\n.navigation-item {\n  -webkit-box-flex: 1;\n          flex: 1;\n  text-align: center;\n  padding: 0px 2px;\n}\n\n.search-wrapper {\n  -webkit-box-flex: 3;\n          flex: 3;\n  display: -webkit-box;\n  display: flex;\n}\n\n@media (max-width: 575px) {\n  .search-wrapper {\n    -webkit-box-flex: 6;\n            flex: 6;\n  }\n}\n\n@media (max-width: 580px) {\n  .left-arrow {\n    display: none;\n  }\n}\n\n@media (max-width: 580px) {\n  .right-arrow {\n    display: none;\n  }\n}\n\n@media (max-width: 580px) {\n  .pdf-word {\n    display: none;\n  }\n}\n\n.prev-span {\n  font-size: 12px;\n  font-weight: bold;\n}\n\n@media (max-width: 630px) {\n  .prev-span {\n    font-size: 10px;\n  }\n}\n\n.next-span {\n  font-size: 12px;\n  font-weight: bold;\n}\n\n@media (max-width: 630px) {\n  .next-span {\n    font-size: 10px;\n  }\n}\n\n.navigation-container {\n  margin-top: 53px;\n}\n\n@media (max-width: 768px) {\n  .navigation-container {\n    font-size: 12px;\n  }\n}\n\n@media (max-width: 630px) {\n  .navigation-container {\n    font-size: 10px;\n  }\n}\n\n.container {\n  margin-top: 57px;\n}\n\n@media (min-width: 768px) {\n  .container {\n    max-width: 925px;\n    padding: 0px;\n  }\n}\n\n@media (max-width: 768px) {\n  .container {\n    max-width: 700px;\n    padding: 0px;\n  }\n}\n\n@media (max-width: 715px) {\n  .container {\n    margin-top: 40px;\n    position: fixed;\n  }\n}\n\n@media (max-width: 768px) {\n  .navbar-brand {\n    font-size: 12px;\n  }\n}\n\n@media (max-width: 630px) {\n  .navbar-brand {\n    font-size: 10px;\n  }\n}\n\n@media (max-width: 768px) {\n  .search-button-elem {\n    padding: 2px;\n    font-size: 12px;\n  }\n}\n\n@media (max-width: 630px) {\n  .search-button-elem {\n    font-size: 10px;\n  }\n}\n\n@media (max-width: 768px) {\n  .search-input-elem {\n    padding: 2px;\n    font-size: 12px;\n    height: 26px;\n  }\n}\n\n@media (max-width: 630px) {\n  .search-input-elem {\n    font-size: 10px;\n  }\n}\n\n@media (max-width: 575px) {\n  .search-input-elem {\n    margin-top: 5px;\n  }\n}\n\n@media (max-width: 768px) {\n  .download-pdf {\n    font-size: 12px;\n  }\n}\n\n@media (max-width: 630px) {\n  .download-pdf {\n    font-size: 10px;\n  }\n}\n\n@media (max-width: 768px) {\n  .num-pages {\n    font-size: 12px;\n  }\n}\n\n@media (max-width: 630px) {\n  .num-pages {\n    font-size: 10px;\n  }\n}\n\n@media (max-width: 445px) {\n  .num-pages {\n    display: none;\n  }\n}\n\n.navbar-brand {\n  white-space: initial;\n  font-size: 15px;\n  line-height: 1;\n}\n\n@media (max-width: 768px) {\n  .navbar-brand {\n    font-size: 12px;\n  }\n}\n\n.copy-link {\n  line-height: 1;\n  font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    function () {
      ...
      _createClass(BookViewComponent, [{
        ...
        value: function linkCopied() {
          ...
          setTimeout(function () {
            _this2.linkCopiedText = 'Copy Link';
          }, 3000);
        }
      }, {
        ...
        value: function getPdfInfoFromRoute() {
          ...
          if (this.bookInfos && this.bookInfos.length && this.pdfName && this.pdfPage) {
            var book = this.bookInfos.find(function (val) {
              return val.bookTitle === _this4.pdfName;
            });
            ...
            this.regIntervalSub = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(500).subscribe(function () {
              ...
              _this4.location.go("/book/".concat(book.bookTitle.replace(/\s/g, '-'), "/").concat(_this4.pdfPage.toString()));
            });
          }
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.bookInfoSub = this.storageService.getupdatedBooksInfo().subscribe(function (out) {
            _this5.bookInfos = out;

            _this5.getPdfInfoFromRoute();
          });
          this.routerSub = this.route.url.subscribe(function (out) {
            if (out.length === 3) {
              _this5.pdfName = out[1].path.replace(/\-/g, ' ');
              _this5.bookURLname = out[1].path;
              _this5.pdfPage = Number(out[2].path);
              _this5.loadingBookSource = "/assets/".concat(out[1].path).concat(_this5.pdfPage - 1, ".pdf");
              ga('set', 'page', "/book/".concat(_this5.pdfName, "/").concat(_this5.pdfPage));
              ga('send', 'pageview');

              _this5.storageService.setPageForBook(_this5.pdfName, _this5.pdfPage.toString());
        ...
        value: function post(serviceUrl) {
          ...
          if (!this.storageService.currentlyRequestingUrl[url] || !block) {
            ...
            return this.http.post(url, yardDates).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              _this7.storageService.currentlyRequestingUrl[url] = false;
              return res;
        ...
        value: function get(serviceUrl) {
          ...
          if (!this.storageService.currentlyRequestingUrl[url]) {
            ...
            return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
              _this8.storageService.currentlyRequestingUrl[url] = false;
              return res;
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
              _this8.storageService.currentlyRequestingUrl[url] = false;
        ...
        value: function handleError(error) {
          ...
          switch (error.status) {
            ...
            case 401:
              ...
              setTimeout(function () {
                _this9.storageService.error401Called = false;
              }, 3000);
